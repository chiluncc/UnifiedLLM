...
class OpenAIMultiChatClientExecutor(ClientExecutor):
    def __init__(self, client: OpenAIMultiChatClientBase, messages: list[MessageBase]):
        super().__init__()
...
class OpenAIMultiChatClientBase(ClientBase, ABC):
    ...
    @override
    def execute(self, messages: list[MessageBase]) -> OpenAIMultiChatClientExecutor:
        return OpenAIMultiChatClientExecutor(self, messages)
